...
instalar = os.path.isfile("/storage/.kodi/addons/plugin.program.gamestarter/resources/bin/installer.sh") 
...
if instalar:
	...
	os.system("sh /storage//storage/.kodi/addons/plugin.program.gamestarter/resources/bin/installer.sh")
