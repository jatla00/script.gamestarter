...
kodi-send --action=Notification"(Gamestarter,Installing IARL,,/storage/.kodi/addons/script.gamestarter/icon.png)"
...
kodi-send --action=Notification"(Gamestarter,IARL addon Installed,,/storage/.kodi/addons/script.gamestarter/icon.png)"